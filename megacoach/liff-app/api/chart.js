...
อ่านจากกราฟจริงเท่านั้น อย่าเดา ตอบ "2 บรรทัดเป๊ะ":
บรรทัด 1: VERDICT: bullish | neutral | bearish
บรรทัด 2: สรุป technical ภาษาไทย ≤90 ตัวอักษร (แนวโน้ม + รูปแบบถ้ามีชัด + แนวรับ/ต้านสำคัญ)`;
...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (cache) {
      ...
      let summary = answer.replace(/VERDICT:.*\n?/i, "").replace(/^[\s*:：\-–—]+/, "").trim();
