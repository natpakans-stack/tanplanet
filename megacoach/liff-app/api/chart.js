...
const SYSTEM = `คุณคือนักวิเคราะห์เทคนิคของ MegaCoach อ่านกราฟแท่งเทียนรายวัน (มีเส้น SMA 20/50/200 + volume) แล้ว "ประสาน" กับปัจจัยพื้นฐาน/มหภาคที่ให้มา
    ...
    const r = await fetch("https://api.openai.com/v1/responses", {
      ...
      body: JSON.stringify({
        ...
        input: [{
          role: "user",
          content: [
            { type: "input_text", text: `[ปัจจัยที่ระบบสกรีนมา]\n${ctx}\n\nอ่านกราฟด้านล่างแล้ววิเคราะห์ตามหัวข้อ` },
